...
internal fun CorChainDsl<QuizQuestionContext>.stubValidationBadAnswers(title: String) = worker {
    this.title = title
    on { stubCase == QuizQuestionStubs.BAD_ANSWERS && state == QuizQuestionState.RUNNING }
    handle {
