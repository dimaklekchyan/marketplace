    ...
    serializersModule = SerializersModule {
        ...
        polymorphicDefaultSerializer(IResponseQuestion::class) {
            ...
            when(it) {
                ...
                is QuestionInitResponse -> QuestionResponseSerializer(QuestionInitResponse.serializer()) as SerializationStrategy<IResponse>
                else -> null
            }
        }
...
fun Json.encodeResponse(response: IResponseQuestion): String = encodeToString(questionResponseSerializer, response)

fun questionApiV1ResponseSerialize(response: IResponseQuestion): String = questionApiV1Mapper.encodeToString(
    questionResponseSerializer, response)

@Suppress("UNCHECKED_CAST")
fun <T : Any> questionApiV1ResponseDeserialize(json: String): T = questionApiV1Mapper.decodeFromString(
    questionResponseSerializer, json) as T

fun questionApiV1RequestSerialize(request: IRequestQuestion): String = questionApiV1Mapper.encodeToString(
    questionRequestSerializer, request)

@Suppress("UNCHECKED_CAST")
fun <T : Any> questionApiV1RequestDeserialize(json: String): T = questionApiV1Mapper.decodeFromString(
    questionRequestSerializer, json) as T
