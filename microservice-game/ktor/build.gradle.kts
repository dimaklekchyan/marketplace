    ...
    sourceSets {
        ...
        val commonMain by getting {
            dependencies {
                ...
                implementation(project(":microservice-game:api-v1"))
                implementation(project(":microservice-game:mappers-v1"))
                implementation(project(":microservice-game:stubs"))
                implementation(project(":microservice-game:common"))
                implementation(project(":microservice-game:biz"))
            }
        }
